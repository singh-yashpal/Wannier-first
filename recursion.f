...
c           read*,alp,bet,A3,B3
            ...
            character*3 coord
            character*60 line
            dimension oned(-2:2*nd,-2:2*nd,0:4,3)
            dimension savd(-2:2*nd,-2:2*nd)
            dimension a3(3),b3(3)
            dimension w7(mxL,mxL,10),lp(3,mxL),w0(10,10)
            dimension w4(10,10,4)
            dimension nsize(0:4)
            data coord/'xyz'/
            data nsize/1,4,10,20,35/
            IF(nsize(np).GT.mxL) STOP  
c 
c
...
c     
            w7(il,ir,8)=oned(lp(1,il),lp(1,ir),1,1)
     &                 *oned(lp(2,il),lp(2,ir),1,2)
     &                 *oned(lp(3,il),lp(3,ir),0,3)
c     
            w7(il,ir,9)=oned(lp(1,il),lp(1,ir),1,1)
     &                 *oned(lp(2,il),lp(2,ir),0,2)
     &                 *oned(lp(3,il),lp(3,ir),1,3)
c     
            w7(il,ir,10)=oned(lp(1,il),lp(1,ir),0,1)
     &                  *oned(lp(2,il),lp(2,ir),1,2)
     &                  *oned(lp(3,il),lp(3,ir),1,3)
            end do
            end do
