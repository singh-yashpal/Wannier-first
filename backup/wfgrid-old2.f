...
!        print *,'state100'
!        print '(5F12.8,1X)', (PSI_COEF(ibas,1,1,1), ibas = 1, 70)
!        print *,'state6'
!        print '(5F12.8,1X)', (PSI_COEF(ibas,6,1,1), ibas = 1, 70)
!        call stopit
...
C
       ...
       DO IW=1,NWAVF
        ...
        print *,'wfgrid1',K_REP,NDM,ITOTWF
        
        print *,'INFOWF',IW, (INFOWF(j,iw),j=1,3)
       END DO
...
!            NDIM=1
            ...
            IWF=IWF+1
             DO IPTS=1,MPTS
              PSIG(IPTS,IW)=PSIG(IPTS,IWF) !density and wave
             END DO
             DO IDIM=2,NDIM
              IWF=IWF+1
              DO IPTS=1,MPTS
