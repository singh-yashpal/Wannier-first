...
C
       SUBROUTINE KAPATCH(IM,MM,POTDV)
C
...
C
       DO LPTS=0,NMSH-1,NMAX
        ...
        CALL NEWWAY(LPTS,MPTS,MDCL,POTDV,BASPHI(1,IM))
       END DO
C      DO I=1,13  
...
C ********************************************************************
C
      SUBROUTINE KNEWWAY(LPTS,MPTS,MDCL,POTDV,BASPHI)
      INCLUDE 'PARAMS'
      INCLUDE 'commons.inc'
      LOGICAL LSETUP
...
C ******************************************************************\
C
       SUBROUTINE KAGETBAS(LSETUP,MPTS,IGP,R,PSIBR,JREP,NBAS)
C
