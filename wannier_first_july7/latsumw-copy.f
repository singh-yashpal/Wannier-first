...
!cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      INCLUDE 'commons.inc'
       ...
       PARAMETER (ILAT=20)
       PARAMETER (IGRID=(2*ILAT+1)**3)
       DIMENSION SMULTI(100),ILM(100),angrid(IGRID),ANGR(3,1000)
       DIMENSION rtvec(3),rr0(3),ccenter(3)
...
C From negative to positive values of n1,n2, and n3
       do ii=1,iicount
          ...
          angrid(ii)=anglat
          do ix=1,3
          rtvec(ix)=rr0(ix)-(n1*TVEC(ix,1)+n2*TVEC(ix,2)+n3*TVEC(ix,3))
          enddo
